 ...
 * @param {string} text
 */
export function showMessage(text: any) {
 ...
 * @param {string} url
 */
export function showLink(url: any) {
  const output = document.getElementById('output');
  if (!output) {
    return;
  }
 ...
 */
export function iconLabel(iconClass: any, labelText: any) {
 ...
 * @param {string} path
 */
export function navToPath(path: any) {
 ...
 * @returns {string}
 */
export function makeGatewayURL(cid: any, path: any) {
 ...
 * @returns {File}
 */
export function jsonFile(filename: any, obj: any) {
 ...
 */
export function makeShareLink(url: any) {
 ...
 */
export function makeClipboardButton(url: any) {
 ...
 * @param {string} str
 */
export function copyStringToClipboard(str: any) {
  // Create new element
 ...
 */
export function showPopupMessage(message: any) {
